...
class SettingsGlobalForm extends sfForm
{
  ...
  public function configure()
  {
    ...
    $this->setWidgets(array(
      ...
      'sort_browser_user' => new sfWidgetFormSelectRadio(array('choices'=>array('alphabetic_title'=>'title', 'alphabetic_ref'=>'reference code', 'lastUpdated'=> 'last updated')), array('class'=>'radio')),
      'sort_browser_anonymous' => new sfWidgetFormSelectRadio(array('choices'=>array('alphabetic_title'=>'title', 'alphabetic_ref'=>'reference code', 'lastUpdated'=> 'last updated')), array('class'=>'radio')),
